...
// Origin of EnergyCollectors must cross half circle with origin at (0, 0, 0)
// and radius equal to 4 * maximum(model.height or model.sideSize)
// and can't be less then 4 meters - this comes from ISO 17497-2:2012:
// Point source in acoustics must be twice as high as mircophone used for
// measurements where point source is always at (0, 0, 8*max(model.sideSize,
// model.height))
