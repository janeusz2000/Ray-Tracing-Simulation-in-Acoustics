...
import { addFrequencySliderForPolarPatterns } from "./src/polarPatterns/addFrequencySliderForPolarPatterns";
import { getEnergyCollectors } from "./src/simulation/getEnergyCollectors";
import { importEnergyCollectorsArrayPerFrequency } from "./src/polarPatterns/importEnergyCollectorsArrayPerFrequency";
import { exit } from "process";

const Chart = require("chart.js");
const context = document.getElementById("myChart").getContext("2d");
// TODO: Refractor this because its ugly C:
