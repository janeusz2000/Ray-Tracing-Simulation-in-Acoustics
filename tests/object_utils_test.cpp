...
struct GaussianRandom : public RandomEngine {
  ...
  float getNext() override { return _dist(_engine); }
...
TEST(SPHERE_METHOD,
     HitObject_VEC3_0_0_1) // MonteCarlo test:
...
TEST(
    SPHERE_METHOD,
    HitObject_VEC3_0_0_minus1) // MonteCarlo test:
                               // https://en.wikipedia.org/wiki/Monte_Carlo_method
{
  std::random_device rd;
  std::mt19937_64 e2(rd());
...
TEST(SPHERE_METHOD,
     HitObject_VEC3_0_1_0) // MonteCarlo test:
                           // https://en.wikipedia.org/wiki/Monte_Carlo_method
{
  std::random_device rd;
  std::mt19937_64 e2(rd());
...
TEST(
    SPHERE_METHOD,
    HitObject_VEC3_0_minus1_0) // MonteCarlo test:
                               // https://en.wikipedia.org/wiki/Monte_Carlo_method
{
  std::random_device rd;
  std::mt19937_64 e2(rd());
...
TEST(SPHERE_METHOD,
     HitObject_VEC3_1_0_0) // MonteCarlo test:
                           // https://en.wikipedia.org/wiki/Monte_Carlo_method
{
  std::random_device rd;
  std::mt19937_64 e2(rd());
...
TEST(
    SPHERE_METHOD,
    HitObject_VEC3_minus1_0_0) // MonteCarlo test:
                               // https://en.wikipedia.org/wiki/Monte_Carlo_method
{
  std::random_device rd;
  std::mt19937_64 e2(rd());
...
TEST(SPHERE_METHODS, Hit_Object_RayHitData_Vec3_0_0_1) {
  ...
  std::vector<Sphere> objectList = {Sphere(Vec3(0, 0, 0), 1),
                                    Sphere(Vec3(0, 0, 4), 1)};
...
TEST(SPHEREWALL_METHOD, Normal) {
  ...
  core::Vec3 normal1 =
      tempSphere.normal(core::Vec3(0, 0, -constants::kDefaultSimulationRadius));
  core::Vec3 normal2 =
      tempSphere.normal(core::Vec3(0, 0, constants::kDefaultSimulationRadius));
  core::Vec3 normal3 =
      tempSphere.normal(core::Vec3(0, constants::kDefaultSimulationRadius, 0));
  core::Vec3 normal4 =
      tempSphere.normal(core::Vec3(0, -constants::kDefaultSimulationRadius, 0));
